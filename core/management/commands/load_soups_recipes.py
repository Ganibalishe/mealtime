# management/commands/load_soups_recipes.py
import json
import os
...
class Command(BaseCommand):
    help = 'Load soup recipes from JSON file'

    def add_arguments(self, parser):
        parser.add_argument(
            '--file',
            type=str,
            default='soups_recipes.json',
    ...
    def _process_recipe(self, recipe_data, existing_ingredients, categories,
        ...
        for ing_data in recipe_data['ingredients']:
            ...
            RecipeIngredient.objects.create(
                ...
                quantity=quantity
                # unit берется автоматически из ингредиента
            )
    ...
    def _determine_category_and_unit(self, ingredient_name, categories):
        ...
        # Grains detection
        grain_keywords = ['рис', 'гречк', 'овсян', 'манн', 'перлов', 'пшен']
