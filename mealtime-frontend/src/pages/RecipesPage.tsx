...
const RecipesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* SEO КОМПОНЕНТ */}
      <SeoHead
        title="Коллекция рецептов для планирования питания | Более 100+ проверенных рецептов | Mealtime Planner"
        description="Большая коллекция рецептов с фильтрацией по времени приготовления, сложности и тегам. Рецепты для завтрака, обеда, ужина и перекусов. Быстрый поиск и удобная фильтрация. Подробные пошаговые инструкции и списки ингредиентов."
        keywords="рецепты, готовка, кулинария, рецепты на каждый день, быстрые рецепты, здоровое питание, планирование питания, меню на неделю, рецепты для завтрака, рецепты для обеда, рецепты для ужина, простые рецепты, рецепты с фото"
