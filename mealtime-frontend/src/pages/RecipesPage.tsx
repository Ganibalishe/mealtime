...
const RecipesPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* SEO КОМПОНЕНТ */}
      <SeoHead
        title="Коллекция рецептов - Выберите рецепты и добавьте их в меню | Mealtime Planner"
        description="Большая коллекция рецептов для планирования питания. Выберите рецепты для завтрака, обеда, ужина и перекусов, и добавьте их в свой календарь питания. Фильтрация по времени приготовления, сложности и тегам. После добавления рецептов в меню мы автоматически создадим список покупок. Подробные пошаговые инструкции и списки ингредиентов."
        keywords="рецепты, готовка, кулинария, рецепты на каждый день, быстрые рецепты, здоровое питание, планирование питания, меню на неделю, рецепты для завтрака, рецепты для обеда, рецепты для ужина, простые рецепты, рецепты с фото, добавить рецепт в меню"
        canonicalUrl="https://mealtime-planner.ru/recipes"
