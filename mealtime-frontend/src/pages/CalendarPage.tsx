...
const CalendarPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* SEO КОМПОНЕНТ */}
      <SeoHead
        title="Планировщик питания на неделю - Умное планирование меню | Mealtime Planner"
        description="Создайте идеальное меню на неделю с нашим планировщиком питания. Автоматическая генерация списков покупок, подбор рецептов, учет калорий и времени приготовления. Планируйте питание для всей семьи, экономьте время и деньги."
