...
const CalendarPage: React.FC = () => {
  ...
  const WelcomeBlock = () => (
    <div className="space-y-8">
      <SeoHead
        title="Mealtime Planner - О нас | Умный планировщик питания для всей семьи"
        description="Mealtime Planner - это современный сервис для планирования питания на неделю. Мы помогаем семьям экономить время и деньги, автоматически создавая меню и списки покупок. Профессионально составленные рационы, готовые меню от диетологов и удобный календарь питания."
        keywords="планировщик питания, meal planning, планирование питания, меню на неделю, список покупок, готовка, кулинария, семейное питание, экономия времени"
  ...
  return (
    <div className="space-y-6">
      {/* SEO КОМПОНЕНТ */}
      <SeoHead
        title="Планировщик питания на неделю - Создайте меню и получите список покупок | Mealtime Planner"
        description="Создайте идеальное меню на неделю с нашим планировщиком питания. Выбирайте рецепты из коллекции, добавляйте их в календарь, и мы автоматически сгенерируем список покупок. Планируйте питание для всей семьи, экономьте время и деньги. Удобный календарь с возможностью перетаскивания рецептов."
        keywords="планировщик питания, меню на неделю, список покупок, рецепты, готовка, meal prep, планирование питания, календарь питания, меню на 7 дней, автоматический список покупок, планирование еды"
        canonicalUrl="https://mealtime-planner.ru"
        structuredData={structuredData}
      />
