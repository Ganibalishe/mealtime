...
const PremiumMenusPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* SEO КОМПОНЕНТ */}
      <SeoHead
        title="Готовые меню питания на неделю | Профессионально составленные рационы | Mealtime Planner"
        description="Сбалансированные готовые меню на неделю от профессиональных диетологов. Экономьте время на планировании питания и получайте идеальные рационы для всей семьи. Выберите меню на 7, 14, 21 или 30 дней с готовыми рецептами и списками покупок."
        keywords="готовые меню, питание на неделю, рационы, планирование питания, сбалансированное меню, премиум меню, меню на 7 дней, меню на 14 дней, меню на 21 день, меню на 30 дней, готовое меню с рецептами, список покупок, meal plan, готовые рационы"
